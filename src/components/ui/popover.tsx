...
function PopoverContent({ className, align = 'center', sideOffset = 4, ...props }: { className?: string; align?: 'center' | 'start' | 'end'; sideOffset?: number; children: React.ReactNode }) {
  return (
...
function PopoverAnchor({ ...props }: { children: React.ReactNode }) {
